...
8. `sidepanel/automatizar-lote/*`
9. `sidepanel/actas/actasStore.js`
10. `sidepanel/actas/actasRender.js`
11. `sidepanel/actas/csvExport.js`
12. `sidepanel/actas/actasConversion.js`
13. `sidepanel/actas/actasBatchConversion.js`
14. `sidepanel/conversor/apiClient.js`
15. `sidepanel/actas/actasOpenPdfs.js`
16. `sidepanel/actas/actasController.js`
17. `sidepanel/conversor/*`
18. `sidepanel/alerts/*`
19. `sidepanel/bootstrap.js`
...
- `apiClient.js` loads before `actasOpenPdfs.js` so the Actas module can build local PDF file URLs without reaching into Conversor internals.
- `actasOpenPdfs.js` loads before `actasController.js` because the controller initializes the new button on startup.
